...
#
# $ python convert_to_mnist_format.py Test 300 data1/t10k-labels-idx1-ubyte data1/t10k-images-idx3-ubyte
# $ python convert_to_mnist_format.py Train 1700 data/train-labels-idx1-ubyte data1/train-images-idx3-ubyte
# $ gzip data/*ubyte
# 
...
def get_labels_and_files(folder, number):
  ...
  filelists = []
  all_folder_names = os.listdir("Train") #folder in which Test images are
  ...
  labelsAndFiles = []
  for label in range(0): #6 total no. folders in Test

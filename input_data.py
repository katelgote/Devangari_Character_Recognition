...
def dense_to_one_hot(labels_dense, num_classes=30):
...
class SemiDataSet(object):
    def __init__(self, images, labels, n_labeled):
        ...
        y = numpy.array([numpy.arange(30)[l==1][0] for l in labels])   #make changes here for no. of classes
        idx = indices[y==0][:15]
        n_classes = y.max() + 1

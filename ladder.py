...
#The code is from https://github.com/rinuboney/ladder
#
# Necessary changes have been made by Kunal Telgote 
#

layer_sizes = [784, 1000, 500, 250, 250, 250, 30]

L = len(layer_sizes) - 1  # number of layers

num_examples = 60000  #30*(1700+300) = 60,000
num_epochs = 20
num_labeled = 100     #check with input_data.py file    # """ make changes here for num labelled """ 
...
batch_size = 90   #NOTE batch size < num_labeled
